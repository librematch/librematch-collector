...
export const maps: IMap[] = [
    ...
    },
    {
        "mapId": -1,
        "mapIdRoR": 301014,
        "enum": "P_Mediterranean",
        "file": "P_Mediterranean"
    },
    {
        "mapId": -1,
        "mapIdRoR": 301015,
    ...
    },
    {
        "mapId": -1,
        "mapIdRoR": 301023,
        "enum": "P_RiverCrossing",
        "file": "P_RiverCrossing"
    },
    {
        "mapId": -1,
        "mapIdRoR": 301024,
    ...
    },
    {
        "mapId": -1,
        "mapIdRoR": 301027,
        "enum": "P_TwinSettlements",
        "file": "P_TwinSettlements"
    },
    {
        "mapId": 9,
        "mapIdRoR": 10875,
...
export function getMapImage(mapId: number) {
    const map = maps.find((m) => m.mapId === mapId || m.mapIdRoR === mapId);
    if (map == null) {
        return '/maps/cm_generic.png';
    }
    return `https://aoe2companion.com/maps/${map.file}.png`;
    // return `http://localhost:4200/maps/${map.file}.png`;
}

export function getMapEnumFromId(mapId: number) {
    const map = maps.find((m) => m.mapId === mapId || m.mapIdRoR === mapId);
    if (map == null) {
        return 'unknown';
    }
...
export function getMapIdFromEnum(mapEnum: string) {
    const map = maps.find((m) => m.enum === mapEnum);
    if (map == null) {
        return 'unknown';
    }
    return map.mapId;
